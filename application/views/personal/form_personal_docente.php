	...
	$(document).ready(function()
	{
		...
		$("#form_editar_docente").validate({
		    ...
		    submitHandler: function() {
				$("#form_editar_docente").on("submit", function(event){
					event.preventDefault();
					var parametros=new FormData($(this)[0]);
					 
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>personal/gestion_personal/insert_update_personal_docente/<?php echo $resp['ID_PRS']?>",
						data: parametros, 
						dataType: "html",
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document" style="width: 500px !important;">
		<div class="modal-content">
			<div class="modal-header" style="padding: 10px; !important">
				<h4 class="modal-title miestilo" id="exampleModalLongTitle"><b>Editar Informacion Docente</b></h4>
			...
			<div class="modal-body" style="padding: 10px; !important">
				<div class="panel-body" style="padding: 0px; !important">
					<form class="form-horizontal" method="post"  enctype="multipart/form-data" action="#" id="form_editar_docente" autocomplete="off">
						<div class='box-body'> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Nombre(s):</label>
								<div class="col-sm-6">
								<input type="text" class="form-control" id='nombre' name='nombre' placeholder='Nombres...' value="<?php echo $resp['NOMBRES_DOC'] ?>">
								</div>
							</div> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Apellido Paterno:</label>
								<div class="col-sm-6">
							...
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Apellido Materno:</label>
								<div class="col-sm-6">
							...
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Ci:</label>
								<div class="col-sm-6">
								<input type="number" class="form-control" id='ci' name="ci" placeholder='Cedula identidad...' value="<?php echo $resp['CI_PRS'] ?>">
								</div>
							</div> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Direccion:</label>
								<div class="col-sm-6">
							...
							<div class='form-group'>
								...
								<div class="col-sm-6">
								<input type="mail" class="form-control" id='mail' name="mail" placeholder='Email ...' value="<?php echo $resp['EMAIL_DOCENTE'] ?>">
								</div>
							</div>
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Foto:</label>
								<div class="col-sm-6">
									<input type="file" class="form-control custom-file-input" id="customFile1"  name="customFile1" accept="image/*" >
								</div>
							</div> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-3 control-label">Especialidad:</label>
								<div class="col-sm-6">
								<input type="text" class="form-control" id='especialidad' name='especialidad' placeholder='Especialidad...' value="<?php echo $resp['ESPECIALIDAD'] ?>">
								</div>
							</div>
						</div>
