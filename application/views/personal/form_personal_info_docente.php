    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document" style="width: 500px !important;">
		<div class="modal-content">
			<div class="modal-header" style="padding: 10px; !important">
				<h4 class="modal-title miestilo" id="exampleModalLongTitle"><b>Informacion Docente</b></h4>
					...
					<form class="form-horizontal" method="post"  enctype="multipart/form-data" action="#" id="form_editar_alumno" autocomplete="off">
						<div class='box-body'> 
							<div class='form-group'>
								...
								<div class="col-sm-8">
								<input type="text" class="form-control" id='nombre' name='nombre' placeholder='Nombres...' value="<?php echo $resp['NOMBRES_DOC'] ?>" disabled>
								</div>
							</div> 
							<div class='form-group'>
							...
							<div class='form-group'>
								...
								<div class="col-sm-8">
								<input type="mail" class="form-control" id='mail' name="mail" placeholder='Email ...' value="<?php echo $resp['EMAIL_DOCENTE'] ?>" disabled>
								</div>
							</div> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-2 control-label">Especialidad:</label>
								<div class="col-sm-8">
								<input type="mail" class="form-control" id='especialidad' name="especialidad" placeholder='Especialidad ...' value="<?php echo $resp['ESPECIALIDAD'] ?>" disabled>
								</div>
							</div> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-2 control-label">Foto:</label>
								<div class="col-sm-8">
								  <image src="<?php echo base_url()?>resources/files/docente/<?php echo $resp['FOTO_NOMB'] ?>" style="width:200px; height:200px" />
								</div>
							</div> 
						</div> 
					</form>
