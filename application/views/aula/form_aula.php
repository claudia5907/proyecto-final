	...
	$(document).ready(function()
	{
		$("#form_editar_aula").validate({
		    ...
		    submitHandler: function() {
				$("#form_editar_aula").on("submit", function(event){
					event.preventDefault();
					var parametros=new FormData($(this)[0]);
					 
					$.ajax({
						type: "POST",
						url: "<?php echo base_url(); ?>aula/gestion_aula/insert_update_aula/<?php echo $resp['ID_AULA']?>",
						data: parametros, 
						dataType: "html",
						contentType: false, //importante enviar este parametro en false
						processData: false, //importante enviar este parametro  
						success: function(msg){
							$("#modal_editar_aula").modal("hide");
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="padding: 10px; !important">
				<div class="panel-body" style="padding: 0px; !important">
					<form class="form-horizontal" method="post"  enctype="multipart/form-data" action="#" id="form_editar_aula" autocomplete="off">
						<div class='box-body'> 
							<div class='form-group'>
								<label for="codigo" class="col-sm-2 control-label">Nombre:</label>
								<div class="col-sm-8">
								<input type="text" class="form-control" id='nombre' name='nombre' placeholder='Nombre aula...' value="<?php echo $resp['NOMB_AULA'] ?>">
								</div>
							</div>
							...
							<div class='form-group'>
								...
								<div class="col-sm-8">
								<input type="text" class="form-control" id='descripcion' name='descripcion' placeholder='Descripcion...' value="<?php echo $resp['DESC_AULA'] ?>">
								</div>
							</div> 
						</div>
