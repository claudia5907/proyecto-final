...
(function ($) {
    ...
    $.fn.moveToList3 = function (destinationList, value, texto) {
         

        //$(destinationList).append($(opts).clone());
        //$(destinationList).append($(opts).clone().appendTo( "<option value='1'>HOLA</option>" ));
        $(destinationList).append("<option value='"+value+"'>"+texto+"</option>");
		console.log("hola"+destinationList);
    };
	$.fn.moveToList2 = function (sourceList, destinationList, value, texto) {
        ...
        //$(destinationList).append($(opts).clone().appendTo( "<option value='1'>HOLA</option>" ));
        $(destinationList).append("<option value='"+value+"'>"+texto+"</option>");
		console.log("hola"+destinationList+"-"+sourceList);
    };
